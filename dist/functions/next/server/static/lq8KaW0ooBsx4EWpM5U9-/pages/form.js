...
/* harmony import */ var _typeform_embed__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("iQVn");
...
class Form extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  ...
  componentDidMount() {
    _typeform_embed__WEBPACK_IMPORTED_MODULE_7___default.a.makeWidget(embedElement, "https://dhakon.typeform.com/to/A7bW0z", {
      hideHeaders: true,
      hideFooter: true,
      opacity: 75,
      onSubmit: function () {
        next_router__WEBPACK_IMPORTED_MODULE_3___default.a.push(_reusecore_src_constants_routes__WEBPACK_IMPORTED_MODULE_4__[/* LANDING */ "b"]);
        axios__WEBPACK_IMPORTED_MODULE_8___default.a.get(`/forms/A7bW0z/responses`, {
          headers: {
          ...
          axios__WEBPACK_IMPORTED_MODULE_8___default.a.post("/message", {
  ...
  render() {
    return __jsx(_containers_App__WEBPACK_IMPORTED_MODULE_6__[/* AppWithAuthentication */ "a"], null, __jsx(_containers_App_app_style__WEBPACK_IMPORTED_MODULE_5__[/* AppWrapper */ "a"], {
      id: "embedElement"
    }));
  }
